// Game Page Enhancements for European Revolution Era
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const characterRoles = {
        ...
        'Arno': 'Master Assassin',
        'Élise de la Serre': 'Templar & Love Interest',
        'Elise': 'Templar & Love Interest',
        'Napoleon Bonaparte': 'French Emperor',
        'Napoleon': 'French Emperor',
        'Jacob Frye': 'Gang Leader Assassin',
        'Jacob': 'Gang Leader Assassin',
        'Evie Frye': 'Master Assassin',
        'Evie': 'Master Assassin',
        'Crawford Starrick': 'Templar Grand Master',
        'Crawford': 'Templar Grand Master'
    };
