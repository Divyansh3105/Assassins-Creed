// Game Page Enhancements for The Desmond Saga
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const characterRoles = {
        'Altaïr': 'Master Assassin',
        'Altaïr Ibn-La\'Ahad': 'Master Assassin',
        'Desmond Miles': 'Modern Day Protagonist',
        'Desmond': 'Modern Day Protagonist',
        'Al Mualim': 'Mentor & Antagonist',
        'Ezio Auditore': 'Master Assassin',
        'Ezio': 'Master Assassin',
        'Leonardo da Vinci': 'Inventor & Ally',
        'Leonardo': 'Inventor & Ally',
        'Cesare Borgia': 'Templar Leader',
        'Cesare': 'Templar Leader',
        'Niccolò Machiavelli': 'Assassin Ally',
        'Machiavelli': 'Assassin Ally',
        'Prince Suleiman': 'Ottoman Prince',
        'Suleiman': 'Ottoman Prince',
        'Connor Kenway': 'Colonial Assassin',
        'Connor': 'Colonial Assassin',
        'George Washington': 'Founding Father',
        'Haytham Kenway': 'Templar Grand Master',
        'Haytham': 'Templar Grand Master'
    };
    ...
    // Hero banner is now fixed, no parallax needed
    // Removed parallax effect to keep banner stationary
